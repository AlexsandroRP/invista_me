...
from usuarios import views as usuario_views # para n confundir com o views acima
...
urlpatterns = [
    ...
    path('novo_investimento/<int:id_investimento>',views.editar, name='editar'), # id dos itens nas urls
